          ...
          {roleName === 'Admin' && (
            <div className="px-3 mb-2 mt-2">
              <button
                ...
                className={`w-full flex items-center gap-2.5 p-2.5 rounded-xl transition-all duration-300 border ${activeTab === 'admin'
                                    ...
                                    >
                                      ...
                                      <div className="px-2 mb-2 flex items-center justify-between gap-1.5">
                                        ...
                                        <button
                                          onClick={(e) => {
                                            e.stopPropagation();
                                            fetchWorkspaceHistory(workspace.id, workspace.session_id, true);
                                          }}
                                        ...
                                        >
                                          <RotateCcw className={`w-3.5 h-3.5 ${isQueryLoading[workspace.id] ? 'animate-spin text-[var(--accent)]' : ''}`} />
                                        </button>
                                      </div>
                                          ...
                                          return filteredSessions.length === 0 ? (
                                            ...
                                            filteredSessions.map((session, idx) => (
                                              <div
                                                ...
                                                onClick={() => {
                                                  if (session.querySessionHistory) {
                                                    localStorage.setItem('selected_query_session', JSON.stringify(session.querySessionHistory));
                                                  }
