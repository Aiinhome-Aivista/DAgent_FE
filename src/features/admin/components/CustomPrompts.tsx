            ...
            {isLoadingList ? (
              ...
              (() => {
                ...
                return filteredPrompts.map((p, idx) => (
                  <div
                    key={idx}
                    className="grid grid-cols-12 gap-4 p-4 items-center hover:bg-[var(--surface-hover)] transition-colors text-sm"
                  >
                    <div
                      className="col-span-3 font-medium text-[var(--text-primary)] truncate"
                    ...
                    <div
                      className="col-span-5 text-[var(--text-secondary)] truncate"
                      title={p.custom_prompt}
                    >
